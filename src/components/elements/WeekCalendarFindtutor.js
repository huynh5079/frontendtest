...
const WeekCalendarFindTutor = ({ onSelectedChange, sessionsPerWeek, }) => {
    ...
    return (_jsxs("div", { className: "week-calendar", children: [selectedSlots.length > 0 && (_jsxs(_Fragment, { children: [" ", _jsxs("button", { onClick: handleClearAll, className: "delete-btn delete-all", children: [" ", "Xo\u00E1 t\u1EA5t c\u1EA3", " "] }), " ", _jsxs("div", { className: "list-event", children: [" ", _jsx("h6", { children: "Danh s\u00E1ch khung gi\u1EDD" }), " ", selectedSlots.map((slot, index) => (_jsxs("div", { className: "event-item", children: [" ", _jsxs("span", { children: [" ", slot.day, ": ", slot.start, " - ", slot.end, " "] }), " ", _jsxs("button", { onClick: () => handleDeleteEvent(index), className: "delete-btn delete-item", children: [" ", "Xo\u00E1", " "] }), " "] }, index))), " "] }), " "] })), _jsx(DnDCalendar, { localizer: localizer, events: events, startAccessor: "start", endAccessor: "end", defaultView: Views.WEEK, views: ["week"], selectable: true, onSelectSlot: handleSelectSlot, onEventDrop: handleEventDrop, onEventResize: handleEventResize, step: 15, timeslots: 2, min: new Date(2025, 0, 1, 7, 0), max: new Date(2025, 0, 1, 22, 0), style: { height: 600 }, culture: "vi", toolbar: false, formats: {
