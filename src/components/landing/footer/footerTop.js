...
const FooterLandingTop = () => {
    return (_jsx("div", { className: "fl-top", children: data.map((item, index) => (_jsxs("div", { className: "fl-item", children: [item.icon, _jsxs("div", { className: "fl-text", children: [_jsx("h3", { children: item.title }), _jsx("p", { children: item.subtitle })] })] }, index))) }));
};
export default FooterLandingTop;
