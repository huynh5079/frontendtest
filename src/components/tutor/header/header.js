...
const HeaderTutor = () => {
    ...
    return (_jsx("header", { id: "tutor-header", children: _jsxs("div", { className: "th-conatiner", children: [_jsxs("div", { ref: notificateRef, className: "notification-wrapper", children: [_jsx(PiBellRingingBold, { className: "icon", onClick: () => setIsNotificateOpen(!isNotificateOpen) }), isNotificateOpen && (_jsxs("div", { className: "sub-notification", children: [_jsx("h4", { children: "Th\u00F4ng b\u00E1o" }), _jsxs("div", { className: "tabs", children: [_jsxs("div", { className: `tab ${activeTab === "all" ? "active" : ""}`, onClick: () => setActiveTab("all"), children: ["T\u1EA5t c\u1EA3", _jsx("span", { className: `underline left ${activeTab === "all" ? "full" : ""}` }), _jsx("span", { className: `underline right ${activeTab === "all" ? "full" : ""}` })] }), _jsxs("div", { className: `tab ${activeTab === "unread" ? "active" : ""}`, onClick: () => setActiveTab("unread"), children: ["Ch\u01B0a \u0111\u1ECDc", " ", countNotificationUnread > 0 &&
                                                ...
                                                ? ""
                                                : "n-unread", children: n.title }, n.id)))] })] }))] }), _jsxs("div", { ref: menuRef, className: "menu-wrapper", children: [_jsx("img", { src: userLogin?.avatarUrl, className: "avatar", onClick: () => setIsMenuOpen(!isMenuOpen) }), isMenuOpen && (_jsx("div", { className: "sub-menu", children: _jsxs("ul", { children: [_jsx("li", { onClick: () => handleClickSubMenu(routes.tutor.information), children: "Th\u00F4ng tin c\u00E1 nh\u00E2n" }), _jsx("li", { onClick: () => handleClickSubMenu(routes.tutor.change_password), children: "\u0110\u1ED5i m\u1EADt kh\u1EA9u" }), _jsx("li", { onClick: () => handleClickSubMenu(routes.tutor.wallet), children: "V\u00ED c\u1EE7a t\u00F4i" }), _jsx("li", { onClick: () => handleClickSubMenu(routes.tutor.schedule), children: "L\u1ECBch d\u1EA1y" }), _jsx("li", { onClick: logout, children: "\u0110\u0103ng xu\u1EA5t" })] }) }))] })] }) }));
};
