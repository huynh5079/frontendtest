...
import type { CancelRequestFindTutorForStudentProps } from "../../types/modal";
...
const CancelRequestFindTutorForStudent: FC<
    CancelRequestFindTutorForStudentProps
> = ({ isOpen, setIsOpen, requestId }) => {
    ...
    const handleCancel = async () => {
        ...
        await dispatch(cancelClassRequestForStudentApiThunk(String(requestId)))
            ...
            .then((res) => {
                ...
                setIsOpen(false);
                navigate(`/student/information?tab=request`);
            })
            .catch((error) => {
...
export default CancelRequestFindTutorForStudent;
