...
import type { UpdateBookingTutorForStudentModalProps } from "../../types/modal";
...
import { formatDateToYMD, groupSchedulesByWeek } from "../../utils/helper";
import { getAllTutorScheduleApiThunk } from "../../services/booking/bookingThunk";
import { selectListTutorSchedule } from "../../app/selector";

const UpdateBookingTutorForStudentModal: FC<
    UpdateBookingTutorForStudentModalProps
...
export default UpdateBookingTutorForStudentModal;
