...
import { selectDetailClassRequestForStudent, selectListApplyRequestFindTutorForStudent, selectListChildAccount, selectListClassRequestForStudent, } from "../../../app/selector";
...
const ParentRequestFindTutor = () => {
    ...
    const handleViewDetail = (id) => navigate(`/parent/information?tab=request&id=${id}`);
