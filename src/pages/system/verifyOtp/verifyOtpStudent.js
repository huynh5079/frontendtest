...
import { registerStudentApiThunk, verifyOtpApiThunk, } from "../../../services/auth/authThunk";
import { toast } from "react-toastify";
import { useDocumentTitle } from "../../../utils/helper";
const VerifyOtpStudentPage = () => {
    ...
    const handleSubmit = async (values, helpers) => {
        ...
        try {
            ...
            const res = await dispatch(registerStudentApiThunk(state)).unwrap();
...
export default VerifyOtpStudentPage;
