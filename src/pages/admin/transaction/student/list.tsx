...
import "../../../../assets/scss/admin/transaction/student/admin_list_student_transaction.scss";
...
const AdminListStudentTransactionPage: FC = () => {
    ...
    const allCount = total; // tổng số giao dịch từ backend
    ...
    return (
        <section id="admin-list-student-transaction-section">
            <div className="alsts-container">
                ...
                {showFilter && (
                    <div className="alstscr-filter">
                        <div className="filter-row">
                            <div className="filter-field">
                                <label htmlFor="filter-type-student">
                                    Loại giao dịch:
                                </label>
                                <select
                                    id="filter-type-student"
                                    value={filterType}
                                    onChange={(e) =>
                                        setFilterType(
                                            e.target.value as
                                ...
                                >
                                    ...
                                    <option value="RefundIn">
                                        Nhận hoàn tiền
                                    </option>
                                    <option value="RefundOut">Hoàn tiền</option>
                                    <option value="DepositRefundIn">
                                        Nhận hoàn cọc
                                    </option>
                                    <option value="DepositRefundOut">
                                        Hoàn cọc
                                    </option>
                                    <option value="PayEscrow">
                                        Thanh toán escrow
                                    </option>
                                    <option value="PayoutIn">
                                        Nhận thanh toán
                                    </option>
                                </select>
                            </div>
                            <div className="filter-field">
                                <label htmlFor="filter-status-student">
                                    Trạng thái:
                                </label>
                                <select
                                    id="filter-status-student"
                                    value={filterStatus}
                                    onChange={(e) =>
                                        setFilterStatus(
                                            e.target.value as
                            ...
                            <div className="filter-field">
                                <label htmlFor="filter-start-date-student">
                                    Từ ngày:
                                </label>
                                <input
                                    id="filter-start-date-student"
                                    type="date"
                                    value={startDate}
                                    onChange={(e) =>
                            ...
                            <div className="filter-field">
                                <label htmlFor="filter-end-date-student">
                                    Đến ngày:
                                </label>
                                <input
                                    id="filter-end-date-student"
                                    type="date"
                                    value={endDate}
