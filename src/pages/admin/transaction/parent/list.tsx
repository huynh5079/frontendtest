...
import "../../../../assets/scss/admin/transaction/parent/admin_list_parent_transaction.scss";
    ...
    return (
        <section id="admin-list-parent-transaction-section">
            <div className="alpts-container">
                ...
                {showFilter && (
                    <div className="alptscr-filter">
                        <div className="filter-row">
                            <div className="filter-field">
                                <label htmlFor="filter-type-parent">
                                    Loại giao dịch:
                                </label>
                                <select
                                    id="filter-type-parent"
                                    value={filterType}
                                    onChange={(e) =>
                                        setFilterType(
                                            e.target.value as
                            ...
                            <div className="filter-field">
                                <label htmlFor="filter-status-parent">
                                    Trạng thái:
                                </label>
                                <select
                                    id="filter-status-parent"
                                    value={filterStatus}
                                    onChange={(e) =>
                                        setFilterStatus(
                                            e.target.value as
                            ...
                            <div className="filter-field">
                                <label htmlFor="filter-start-date-parent">
                                    Từ ngày:
                                </label>
                                <input
                                    id="filter-start-date-parent"
                                    type="date"
                                    value={startDate}
                                    onChange={(e) =>
                            ...
                            <div className="filter-field">
                                <label htmlFor="filter-end-date-parent">
                                    Đến ngày:
                                </label>
                                <input
                                    id="filter-end-date-parent"
                                    type="date"
                                    value={endDate}
