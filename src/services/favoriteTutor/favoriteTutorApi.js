...
export const favoriteTutorApi = async (tutorProfileId) => {
    const data = await request.post(`/favorite-tutors/${tutorProfileId}`);
    return data.data;
};
export const checkFavoriteTutorApi = async (tutorProfileId) => {
    const data = await request.get(`/favorite-tutors/check/${tutorProfileId}`);
    return data.data;
};
export const deleteFavoriteTutorApi = async (tutorProfileId) => {
